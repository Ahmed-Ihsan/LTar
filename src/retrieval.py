...
from src.exceptions import ChromaDBCorruptionError, RetrievalError
...
class ContextChunk:
    ...
    Mirrors :class:`src.ingestion.Chunk` plus the ``distance`` reported by
    ChromaDB (lower = more similar under cosine space). Used by
