...
# All versioned prompt constants, auto-generated via introspection of the
# module-level uppercase string constants (CS-22). Used by regression tests
# (PROMPTS.md §5) to guard against silent drift of the mandatory rule markers.
