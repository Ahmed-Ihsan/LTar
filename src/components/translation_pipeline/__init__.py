...
_LAZY: dict[str, str] = {
    ...
    "GeminiAuthError": f"{__name__}.exceptions",
    "GeminiQuotaError": f"{__name__}.exceptions",
    ...
    "LLMConnectionError": f"{__name__}.exceptions",
    "LLMRuntimeError": f"{__name__}.exceptions",
    "LLMTimeoutError": f"{__name__}.exceptions",
