...
from src.components.interfaces.cli import (
    _audit_trace_markdown as _audit_trace_md,
)
from src.components.interfaces.cli import (
                ...
                if hitl_active and reviewer is not None:
                    ...
                    with self._lock:
                        self._result = _PendingResult(
                            ...
                            translation=draft,
                            provenance=_provenance_md(state),
                            audit_trace=_audit_trace_md(history),
                        )
                    ...
                    result: UiTranslationResult = UiTranslationResult(
                        ...
                        provenance_md=_provenance_md(reviewed),
                        audit_trace_md=_audit_trace_md(history),
                    )
                else:
