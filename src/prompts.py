...
# The user-turn template is unchanged from V3 (it carries no rule text); it is
# versioned only so ALL_PROMPT_CONSTANTS stays a complete version set.
TRANSLATOR_USER_TEMPLATE_V4: str = TRANSLATOR_USER_TEMPLATE_V3
...
AUDITOR_USER_TEMPLATE_V4: str = AUDITOR_USER_TEMPLATE_V3
