...
### Requirement: LLM engine adapter protocol with dependency injection
...
### Requirement: Embedding adapter protocol with dependency injection
...
### Requirement: Structured run logging with single responsibility
